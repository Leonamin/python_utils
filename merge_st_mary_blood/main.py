...
base_path = 'st_mary_blood'
file_order = ['info', 'form_answer', 'task_achieve']
...
# 결과 저장
result_df.to_excel('st_mary_blood_combined.xlsx', index=False)
print("완료: st_mary_blood_combined.xlsx")
